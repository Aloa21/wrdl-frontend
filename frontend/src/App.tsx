...
function App() {
  ...
  useEffect(() => {
    if (isConnected && chainId !== monad.id) {
          ...
          <div className="homepage-left">
            <div className="homepage-message">
              ...
              <p className="homepage-nad-info">
                Available on <a href="https://nad.fun" target="_blank" rel="noopener noreferrer"><img src="/nad-fun-logo.svg" alt="nad.fun" className="nad-fun-logo" /> nad.fun</a>
              </p>
            </div>
            <div className="homepage-bottom">
              <div className="homepage-powered-by">
                ...
                <a href="https://monad.xyz" target="_blank" rel="noopener noreferrer" className="monad-link">
                  <img src="/monad-logo.svg" alt="Monad" className="monad-logo" />
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="card connect-screen">
          <div className="card-content">
            ...
            <p className="connect-desc">
              Please approve the network switch to Monad in your wallet.
            </p>
          </div>
